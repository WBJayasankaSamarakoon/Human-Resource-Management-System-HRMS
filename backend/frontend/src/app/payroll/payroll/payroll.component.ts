...
export class PayrollComponent {
  ...
  register() {
    this.http
      ...
      .subscribe((resultData: any) => {
        ...
        this.getAllPayrolls(); // Refresh table after adding
        this.resetForm();
        $('#addPayrollModal').modal('hide'); // Close modal after successful save
      });
  }
  ...
  updateRecords() {
    this.http
      ...
      .subscribe((resultData: any) => {
        ...
        this.resetForm();
        $('#addPayrollModal').modal('hide'); // Close modal after successful update
      });
  }
  ...
  setDelete(payroll: any) {
    // Make sure the correct payroll_id is passed to delete
    this.http
      .delete(`${apiBaseUrl}api/payrolls/${payroll.payroll_id}`)
      .subscribe((resultData: any) => {
        alert('Payroll Deleted Successfully');
        this.getAllPayrolls(); // Refresh table after deletion
      });
  }
